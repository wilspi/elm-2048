...
var $author$project$Main$randomPickCell = function (grid) {
	return A2(
		$elm$random$Random$generate,
...
var $author$project$Main$addTile = F3(
	function (_v0, value, model) {
		var x = _v0.a;
		var y = _v0.b;
...
var $author$project$Main$transposeForIdx = F3(
	function (idx, list, grid2) {
		transposeForIdx:
		while (true) {
			var _v0 = A2($elm$core$Array$get, 0, list);
			if (_v0.$ === 'Just') {
				var e = _v0.a;
				var $temp$idx = idx + 1,
					$temp$list = A3(
					...
					list),
					$temp$grid2 = function () {
					var _v1 = A2($elm$core$Array$get, idx, grid2);
					if (_v1.$ === 'Just') {
						var l = _v1.a;
						return A3(
							$elm$core$Array$set,
							idx,
							A2($elm$core$Array$push, e, l),
							grid2);
					} else {
						return A2(
							$elm$core$Array$push,
				...
				list = $temp$list;
				grid2 = $temp$grid2;
				continue transposeForIdx;
			} else {
				return grid2;
			}
		}
	});
var $author$project$Main$transposeMap = F2(
	function (grid2, grid1) {
		transposeMap:
		while (true) {
			var _v0 = A2($elm$core$Array$get, 0, grid1);
			if (_v0.$ === 'Just') {
				var e = _v0.a;
				var $temp$grid2 = A3($author$project$Main$transposeForIdx, 0, e, grid2),
					$temp$grid1 = A3(
					$elm$core$Array$slice,
					1,
					$elm$core$Array$length(grid1),
					grid1);
				grid2 = $temp$grid2;
				grid1 = $temp$grid1;
				continue transposeMap;
			} else {
				return grid2;
			}
		}
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('above-grid')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('below-grid')
					]),
				_List_fromArray(
					[
